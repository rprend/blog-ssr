      ...
      <main class="max-w-2xl px-4 pb-12 pt-6">
        ...
        <div class="space-y-6">
          ...
          <div class="space-y-4">
            <div>
              <a
                href="https://github.com/rprendergast"
                target="_blank"
            ...
            <div>
              <a
                href="https://linkedin.com/in/ryan-prendergast"
                target="_blank"
                rel="noopener noreferrer"
                class="text-lg text-primary hover:opacity-80 transition-opacity flex items-center gap-2"
              >
            ...
            <div>
              <a
                href="https://instagram.com/rprendergast"
                target="_blank"
                rel="noopener noreferrer"
                class="text-lg text-primary hover:opacity-80 transition-opacity flex items-center gap-2"
              >
            ...
            <div>
              <a
                href="https://youtube.com/@rprendergast"
                target="_blank"
                rel="noopener noreferrer"
                class="text-lg text-primary hover:opacity-80 transition-opacity flex items-center gap-2"
              >
            ...
            <div>
              <a
                href="https://letterboxd.com/rprendergast"
                target="_blank"
                rel="noopener noreferrer"
                class="text-lg text-primary hover:opacity-80 transition-opacity flex items-center gap-2"
              >
